  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-emerald-900">
        ...
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <Card className="p-8 shadow-2xl border-0 bg-white/10 backdrop-blur-md text-white">
            <form onSubmit={handleSubmit} className="space-y-6">
              <Alert className="bg-blue-900/50 border-blue-400/50 text-blue-100">
